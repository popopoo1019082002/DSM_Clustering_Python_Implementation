...
def perform_clustering(dsm_matrix, sub_systems):
    """
    Performs clustering on the DSM matrix and prints out the clustering labels and cluster details.
    ...
    # Fit the algorithms and predict labels
    ...
    # Return the labels for each clustering method
    return {
